...
(<https://datacarpentry.org/R-ecology-lesson/01-intro-to-r.html>), but
some contents are omitted/modified so that they fit DASC 3240.
...
assignments. You may use a shortcut (e.g., "Alt" + "-") to type `<-`
